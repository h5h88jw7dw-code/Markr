{
  "markdown": "[Skip to main content](https://indiankanoon.org/doc/1839963/#main-content)
...
\\- ...\\\\
\\\\
Upgrade to Premium](https://indiankanoon.org/prism/)

\\[Cites [15](https://indiankanoon.org/search/?formInput=cites:1839963), Cited by [517](https://indiankanoon.org/search/?formInput=citedby:1839963)\\]
...
### Author: [A.K. Sarkar](https://indiankanoon.org/search/?formInput=authorid:a-k-sarkar)

### Bench: [A.K. Sarkar](https://indiankanoon.org/search/?formInput=benchid:a-k-sarkar), [J.R. Mudholkar](https://indiankanoon.org/search/?formInput=benchid:j-r-mudholkar)
...
High Court on March 3, 1955, on the ground that s. 5 of\t the
...
Constitution was not maintainable, because the Collector had
...
Sub-section (1) of [s. 3](https://indiankanoon.org/doc/51380823/) of the Import and Exports (Control)
...
Defence of India Rules which by virtue of [s. 4](https://indiankanoon.org/doc/51081052/) of the Act of
...
342
1948, a licence was granted to the appellant to import from
...
Calcutta on July 27, 1953, under [s. 253](https://indiankanoon.org/doc/663882/) of the Code of
...
appellant and another person under [s.5](https://indiankanoon.org/doc/82217466/) of the Act of 1947.
...
the Sea Customs Act, read with [s. 3(2)](https://indiankanoon.org/doc/144548959/) of the Act of 1947
and why further penalty should not be imposed on them under
...
Court at Calcutta under [Art. 226](https://indiankanoon.org/doc/1712542/) of the Constitution for a
...
Sub-section (2) of [s. 3](https://indiankanoon.org/doc/51380823/) of the Act of 1947 provides that
...
by an order made under [s. 3(1)](https://indiankanoon.org/doc/36342789/) of the Act of 1947 but he has
...
that a breach of the conditions of a licence is not a breach
...
be that the appellants would not have to establish
...
destroyed. [That Act](https://indiankanoon.org/doc/107752922/) was intended to preserve and advance
...
advanced on behalf of the customs authorities that a breach
...
driver was held liable to be penalised under [s. 19](https://indiankanoon.org/doc/107752922/) of the
...
[Imports and Exports (Control) Act](https://indiankanoon.org/doc/107752922/). Then I find that in our
country too the same view has been taken. Thus in [Emperor\\\\
v. Abdul Hamid Mullick, J.](https://indiankanoon.org/doc/1486850/), observed,
\"When a notification is issued by an executive
...
(8). Suppose the order under [s. 3 (1)](https://indiankanoon.org/doc/36342789/) of the Imports and
...
[Art. 226](https://indiankanoon.org/doc/1712542/) of the Constitution.
...
Director of that Company. On September 27, 1948, the
...
and others for alleged offences under [s. 4201120B](https://indiankanoon.org/doc/1569253/) of the
...
355
offence under [s. 5](https://indiankanoon.org/doc/82217466/) of the Imports and Exports (Control)
...
the learned Presidency Magistrate discharged all the accused
in both the cases under [s. 253](https://indiankanoon.org/doc/663882/) of the Code of Criminal
...
420 of the [Indian Penal Code](https://indiankanoon.org/doc/1569253/), as, in his view, there was no
...
appellant No- 2 of the offence under [s. 420](https://indiankanoon.org/doc/1436241/), Indian Penal
...
adjourned from time to time at
357
the request of the respondent. On May 28, 1955, the
respondent started a proceeding purported to be under s.
167(8) of the Sea Customs Act, read with [s. 3(2)](https://indiankanoon.org/doc/144548959/) of the Act
...
Court at Calcutta under [Art. 226](https://indiankanoon.org/doc/1712542/) of the Constitution for the
...
read with [s. 3(2)](https://indiankanoon.org/doc/144548959/) of the Imports and Exports (Control)
...
of the provisions of [s.5](https://indiankanoon.org/doc/82217466/) of the Act, read with s.3(2)
...
by the Order within the meaning of [s. 3](https://indiankanoon.org/doc/51380823/) of the Act. (4) The
...
with [s.3(2)](https://indiankanoon.org/doc/144548959/) of the Act. (5) As the appellants imported goods
...
it represents the said goods, and, in any view, as the order
...
appellants under [Art. 226](https://indiankanoon.org/doc/1712542/) of the Constitution for the issue
...
> with [s.3(2)](https://indiankanoon.org/doc/144548959/) of the Act. Learned counsel for the respondent
...
at this stage to read the relevant parts of [ss. 3](https://indiankanoon.org/doc/51380823/) and [5](https://indiankanoon.org/doc/82217466/) of
the Act and as, 19 and 167(8) of the Sea Customs Act.

[Imports and Exports (Control) Act, 1947](https://indiankanoon.org/doc/107752922/) [Section 3](https://indiankanoon.org/doc/51380823/). (1) The Central Government may, by
order published in the Official Gazette, make
provisions for prohibiting, restricting or
otherwise controlling, in all cases or i
n
...
[Section 5](https://indiankanoon.org/doc/82217466/). Penalty-If any person contravenes
...
[section 3](https://indiankanoon.org/doc/51380823/), be punishable with imprisonment for
...
> exercise of the power conferred upon it by [s. 3](https://indiankanoon.org/doc/51380823/) of the Act,
...
> See,
> 365 [Customs Act](https://indiankanoon.org/doc/1059693/). By reason of [s. 3(2)](https://indiankanoon.org/doc/144548959/) of the Act, all goods to
> which any order under sub-s. (1) of [s. 3](https://indiankanoon.org/doc/51380823/) applies shall be
...
if an order issued under [s. 3](https://indiankanoon.org/doc/51380823/) of the Act was infringed
...
an offence under [s. 5](https://indiankanoon.org/doc/82217466/) of the Act. This raises the question
...
Under Art,. 215, every High Court shall be a court of record
and shall have all the powers of such a court including the
power to punish for contempt of itself. Under [Art. 226](https://indiankanoon.org/doc/1712542/), it
...
Under [Art. 227](https://indiankanoon.org/doc/1331149/) it has jurisdiction over all courts and
...
only if there was a contravention of the order issued under [s. 3](https://indiankanoon.org/doc/51380823/) of the Act. Does any order so issued by its own force
...
does not impose a condition in the matter of issuing a
...
>  3](https://indiankanoon.org/doc/51380823/) of the Imports and Exports (Control) Act,
...
Exports (Control) Act, 1947](https://indiankanoon.org/doc/107752922/) (XVIII of 1947),
...
decisions made by the Government of India
370
...
r. (3) of r. 84 of the Defence of India Rules or [s. 3 (3)](https://indiankanoon.org/doc/133405625/) of
the Act, as the case may be. The Central Government itself
makes a clear distinction in the form adopted in issuing the
notice. Secondly, while the notifications issued under [s. 3](https://indiankanoon.org/doc/51380823/)
of the Act are described as orders, the notices are
described as \"public notices\"; while the notifications under [s. 3](https://indiankanoon.org/doc/51380823/) of the Act regulate the rights of parties, the public
...
repealed, if the new order in any manner modifies or
...
exercise of the power conferred by [ss. 3](https://indiankanoon.org/doc/51380823/) and [4-A](https://indiankanoon.org/doc/52107608/) of the Act
made an order and under el. 12 thereof the orders contained
in
372
Schedule IV were repeated; Schedule IV only mentioned five
notifications issued under [s. 3](https://indiankanoon.org/doc/51380823/) of the Act, but no public
...
High Court that the policy-statements are issued under [s. 3](https://indiankanoon.org/doc/51380823/)
...
notices are not orders issued under [s. 3](https://indiankanoon.org/doc/51380823/) of the Act.
...
imported without
373
licence in contravention of the order issued under a. 3 of
...
power conferred on it by [s.3](https://indiankanoon.org/doc/51380823/) of the Act to provide for
...
>  of a licence that the same has been issued
...
restrictions
375
imposed under [s.3](https://indiankanoon.org/doc/51380823/) of the Act and that, as in the instant
...
[⚖Case Recast AI](https://indiankanoon.org/prism/case-recast/1839963/ \"Re-decide this case with AI — independent verdict and reasoning\")

![Prism Logo](https://indiankanoon.org/static/chat/images/logo.png)Talk with IK doc

![Upload and Chat](https://indiankanoon.org/static/chat/images/UploadChat.png)Talk with IK doc
...
New user? [Sign up here](https://indiankanoon.org/members/signup/?nextpage=%2Fdoc%2F1839963%2F)

What is this doc about?Summarize the key points

East India Commerclal Co., Ltd. ... vs The Collector Of Customs, Calcutta on 4 May, 1962

[Powered by Prism](https://indiankanoon.org/prism/)
...
Your feedback will be used to help improve Google Translate",
  "metadata": {
    "title": "East India Commerclal Co., Ltd. ... vs The Collector Of Customs, Calcutta on 4 May, 1962",
    "language": "en",
    "scrapeId": "01a00eee-eb3e-7728-9f1c-fe84476b850b",
    "sourceURL": "https://indiankanoon.org/doc/1839963/",
    "url": "https://indiankanoon.org/doc/1839963/",
    "statusCode": 200,
    "contentType": "text/html; charset=utf-8",
    "timezone": "America/New_York",
    "proxyUsed": "basic",
    "cacheState": "miss",
    "indexId": "3edfd8f6-75cf-4661-b8cf-45c643a1f8d6",
    "creditsUsed": 1,
